...
- Generic leases / session: [Soft Suspend (contributor)](../../contributing/device/suspend/soft-suspend.md)
- Shared suspend cycle: [Suspend orchestrator](../../contributing/device/suspend/orchestrator.md)
- Kobo deep idle + Auto Suspend: [Kobo suspend](../../contributing/device/suspend/kobo/suspend.md)
