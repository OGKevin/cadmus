...
pub struct Device {
    ...
    pub(super) wifi_manager: std::sync::Arc<crate::device::wifi::KoboWifiManager>,
    pub(super) usb_manager: std::sync::Arc<crate::device::usb::KoboUsbManager>,
    pub(super) power_manager: std::sync::Arc<crate::device::power::KoboPowerManager>,
...
crate::impl_device_hardware!(
    ...
    WifiManager = crate::device::wifi::KoboWifiManager,
    UsbManager = crate::device::usb::KoboUsbManager,
    PowerManager = crate::device::power::KoboPowerManager,
    Rtc = LinuxRtc;
    override
