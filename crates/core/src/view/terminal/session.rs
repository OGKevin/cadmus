...
use crate::view::toggleable_keyboard::{Layout, ToggleableKeyboard};
...
fn apply_pending_renderer_configuration(
    ...
    *renderer = TerminalRenderer::new_with_font_size(
    ...
    shared.hub.send(Event::WakeUp.into()).ok();
}
...
mod tests {
    ...
    fn fake_terminal() -> (
        ...
        AppContext,
        crate::view::Hub,
        Receiver<crate::view::HubMessage>,
        RenderQueue,
    ) {
